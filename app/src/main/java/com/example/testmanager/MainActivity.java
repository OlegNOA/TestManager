...
import com.example.testmanager.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity implements OnItemsClick{
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        mainSearchBtn = findViewById(R.id.main_person_btn);
    ...
    private void setUpGraph() {
        ...
        if (income!=0){
            ...
            colorsList.add(getResources().getColor(R.color.chat_color_receiver));
        }
        if (expense !=0){
