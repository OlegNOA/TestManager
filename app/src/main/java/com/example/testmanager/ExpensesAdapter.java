...
public class ExpensesAdapter extends RecyclerView.Adapter<ExpensesAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (expenseModel.getType().equals("Income")) {
            textColor = ContextCompat.getColor(context, R.color.chat_color_receiver);
        } else {
        ...
        holder.rubTextView.setTextColor(textColor);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        private TextView note,category,amount,date,rubTextView;
        public MyViewHolder(@NonNull View itemView){
            ...
            rubTextView = itemView.findViewById(R.id.rubTextView);
        }
